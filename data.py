...
QUESTIONS = {
    ...
    'q122a': "Is LIKE followed by a figuratively used expression requiring non-literal interpretation?\n or \nIs there a potential non-equivalence between what was said and what was meant, suggesting limited epistemic/lexical commitment and requiring hedging?",
...
RESULTS_HELP = {
    ...
    'result_clar':  "**LIKE** occurs clause initially (always at the beginning of S2) and functions as a discourse link between two discourse segments (S1 LIKE+S2).\nIn this case the relationship between the two segments is **clarification**, so S2 clarifies information given in S1.\n**LIKE** can be paraphrased as 'to clarify (what I mean)' in this case.\nThe same function can be fulfilled by the construction **IT'S LIKE**.\n\n**Examples:**\n\n_S0644: so but and the reason I got that partly is cos ++you know they do plagiarism now++ (S1)? **LIKE** (S2) ++they can scan your work to see if it’s plagiarised++ mine was forty percent plagiarised which again was the maximum_",
